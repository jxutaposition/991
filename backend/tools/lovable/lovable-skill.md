...
- **Lovable chat changes deploy immediately.** There is no staging — the live preview may be the deployed surface. Treat high-impact prompts as irreversible until verified.
...
- **Supabase and Clay are separate.** If a table is empty, the upstream write step may be missing.
